      ...
      <div className='flex'>
        ...
        <div className='w-[80%] h-full my-10 mx-6'>
          ...
          <div className='mt-8 flex justify-between border-b-[1px] border-[#B6A9A9] pb-2'>
            <h4 className='text-[26px] leading-[56px] font-medium'>Create Schedule</h4>
            ...
            <form className='my-8'>
              ...
              <div className='flex gap-8'>
                ...
                <div className='flex flex-col'>
                  ...
                  <input className="w-[300px] h-[40px] border border-[#E2E8F0] rounded-md px-3 focus:outline-none appearance-none bg-white">
                  </input>
