...
export default function EditSchedule() {
  ...
  const sidebarTitles = [
    {id : "1", icon: ClockIcon, title : "Schedule Management", path: "/edit-schedule",active:0 },
    {id : "2", icon: VesselIcon, title : "Vessel Management",path: "/vessel-list",active:1  },
         ...
         {/*  <div className='mt-8 flex justify-between border-b-[1px] border-[#B6A9A9] pb-2'>
          ...
          <div className='mt-4'>
           {/*  <p className='text-[16px] text-[#16A34A] border-b-[1px] font-medium border-[#0000001A] pb-4'>
             ...
             <h3 className='text-h3 section_title'>
              Origin Port
            </h3>
          </div>
          ...
          <div>
            <form className='my-8'>
              ...
              <div className='flex gap-6 mt-8'>
                <button className='primary_btn save_btn'> 
                  Save
                </button>
{/* 
               ...
               <button className='primary_btn bg-white cancel_btn'> 
                  Cancel
                </button> 
              </div>
            </form>
